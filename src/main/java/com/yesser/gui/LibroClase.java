...
import com.yesser.dao.LibroDaoImpl;
...
public class LibroClase extends JInternalFrame {
    ...
    private void inicializarLibroClase() {
        ...
        entradaTexto.setText("Luna de pluton");
        ...
        btnEditar.setToolTipText("Edita los cambios de los campos del Formulario");
        ...
        btnGuardar.addActionListener((ActionEvent arg0) -> {
            ...
            LibroDao daoimpl = new LibroDaoImpl();
